...
$(document).ready(function () {
    ...
    // Prevents submission of form on autocomplete
...
<<<<<<< HEAD:Loccasion_Web_App/js/create-eventOLD.js
    console.log("Tags: " + tags[0] + "  " + tags[1] + "  " + tags[2] + "  " + tags[3] + "  ");
=======
    console.log("Tags: " + tags[0] + ",  " + tags[1] + ",  " + tags[2] + ",  " + tags[3] + "  ");
>>>>>>> 594640a5d2f1e0e733f725202c9c7d2e32e03c5a:js/create-event.js
