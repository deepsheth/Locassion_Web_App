...
<body id="faq">
    ...
    <div class="container">
        ...
        <ul class="collapsible" data-collapsible="expandable">
            ...
            <li>
                <div class="collapsible-header">Who created Loccasion?</div>
                <div class="collapsible-body">
                    <p>
